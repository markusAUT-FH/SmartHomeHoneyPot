...
if __name__ == "__main__":
    ...
    rtsp_server = 'rtsp://localhost:8554/mystream' # push server (output server)
    
    #pull rtsp data, or your cv cap.  (input server)
    cap = cv2.VideoCapture("/home/markus/SmartHomeHoneyPot/demo-video/big_buck_bunny_480p_10mb.mp4")
